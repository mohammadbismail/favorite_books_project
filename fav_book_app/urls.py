...
urlpatterns = [
    ...
    path(
        "books/add_book_to_user_list_of_favorites/<int:book_id>/",
        views.add_book_to_user_list_of_favorites,
    ),
    # end
    ...
    path(
        "books/remove_book_from_user_favorite_list/<int:book_id>/",
        views.remove_book_from_user_favorite_list,
    ),
]
